...
export default function Page() {
  ...
  const objections = [
    {
      objection: "Search is still performing, so we don’t see a problem.",
      response:
        "That can absolutely be true at the channel level. The question is whether the portfolio is still the most efficient system overall as spend scales and blended CAC starts to drift.",
    },
    {
      objection: "We already tested upper funnel and it did not work.",
      response:
        "A lot of tests fail because the portfolio mix didn’t change enough to test the actual hypothesis. We’d run a controlled reallocation with clear guardrails and measure the blended outcome.",
    },
    {
      objection: "We don’t want to disrupt what’s already working.",
      response:
        "That’s exactly why this should be controlled and reversible. Hold spend flat, move a defined percentage, and inspect the result before making a bigger decision.",
    },
    {
      objection: "This feels risky.",
      response:
        "The lower-risk move is usually to test in a constrained way now rather than wait until CAC drift becomes a larger system problem.",
    },
  ];
