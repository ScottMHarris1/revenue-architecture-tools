...
- Modeled revenue lift: ${formatMoney(analysis.projectedRevenueLift)}
              ...
              <Card>
                ...
                <div style={{ display: "grid", gap: 18 }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                    ...
                    <Field label="Alternative shift (%)"><NumberInput value={state.comparisonShift} onChange={(v) => update("comparisonShift", v)} /></Field>
                  </div>
                ...
                <div className="print-card">
                  <Card>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
                      <div>
                        <div style={{ fontSize: 12, textTransform: "uppercase", color: "#64748b", letterSpacing: 0.8 }}>Portfolio Efficiency Brief</div>
                  ...
                  <div style={{ marginTop: 16, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                    <div style={{ border: "1px solid #e2e8f0", borderRadius: 18, padding: 16, background: "#f8fafc" }}>
                      ...
                      <div style={{ marginTop: 12, display: "grid", gap: 10 }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between" }}><span>Modeled revenue lift</span><strong>{formatMoney(analysis.projectedRevenueLift)}</strong></div>
                      </div>
                    </div>
                    <div style={{ border: "1px solid #e2e8f0", borderRadius: 18, padding: 16, background: "#f8fafc" }}>
                      <div style={{ fontSize: 12, textTransform: "uppercase", color: "#64748b" }}>Alternative scenario</div>
                      ...
                      <div style={{ marginTop: 12, display: "grid", gap: 10 }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between" }}><span>Modeled revenue lift</span><strong>{formatMoney(comparison.projectedRevenueLift)}</strong></div>
                      </div>
                    </div>
                  </div>
                </Card>
